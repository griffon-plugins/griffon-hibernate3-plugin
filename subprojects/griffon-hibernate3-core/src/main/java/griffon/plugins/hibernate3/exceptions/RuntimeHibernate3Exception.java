 ...
 */
package griffon.plugins.hibernate3.exceptions;
 ...
 */
public class RuntimeHibernate3Exception extends GriffonException {
    private final String sessionFactoryName;

    public RuntimeHibernate3Exception(@Nonnull String sessionFactoryName, @Nonnull Exception sqle) {
    ...
    @Nonnull
    public String getHibernate3Name() {
