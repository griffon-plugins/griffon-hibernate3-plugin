...
class Hibernate3AwareASTTransformationSpec extends Specification {
    def 'Hibernate3AwareASTTransformation is applied to a bean via @Hibernate3Aware'() {
        ...
        @griffon.transform.hibernate3.Hibernate3Aware
        class Bean { }
        new Bean()
        ''')
    ...
    def 'Hibernate3AwareASTTransformation is not applied to a Hibernate3Handler subclass via @Hibernate3Aware'() {
        ...
        class Hibernate3HandlerBean implements Hibernate3Handler {
            @Override
             <R> R withHbm3Session(@Nonnull Hibernate3Callback<R> callback) throws RuntimeHibernate3Exception {
                return null
            }
            @Override
             <R> R withHbm3Session(@Nonnull String sessionFactoryName, @Nonnull Hibernate3Callback<R> callback) throws RuntimeHibernate3Exception {
                return null
            }
            @Override
