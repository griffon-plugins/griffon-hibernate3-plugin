...
:linkattrs:
:project-name: griffon-hibernate3-plugin
...
The Hibernate3 plugin enables lightweight access multiple datasources using link:http://hibernate.org/orm/[Hibernate 3, window="_blank"]
